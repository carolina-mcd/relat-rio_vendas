...
## 📈 Análises realizadas
- Limpeza de dados
- Criação de métricas (faturamento)
...
## 🧠 Insights
- Produtos de beleza concentram maior volume de vendas
- Categoria moda apresenta maior ticket médio
- Existe variação de vendas ao longo do tempo
...
## 💼 Sobre
Projeto desenvolvido para portfólio na área de dados.
